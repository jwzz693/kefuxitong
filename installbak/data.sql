...
CREATE TABLE `wolive_business`  (
  ...
  `chat_tpl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'default' COMMENT '访客界面模板',
...
-- ----------------------------
-- Table structure for wolive_marquee_ad
-- ----------------------------
...
-- ----------------------------
-- Table structure for wolive_payment_method
-- ----------------------------
