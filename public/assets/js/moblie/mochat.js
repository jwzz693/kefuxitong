...
function put1() {
    ...
    var value = $('input[name="upload1"]').val();
...
function putfile1() {
    ...
    var value = $('input[name="folder1"]').val();
...
function checkchat(){
    ...
    $.ajax({
        ...
        url:ROOT_URL+"/admin/event/checkchat",

        type: 'post',

        data: {visiter_id:visiter_id,  business_id: business_id,  business_id: business_id,service_id:service_id},
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            if(res.code == 0){
                ...
                str += "<div class='outer-left'><div class='service'><p style='font-weight:blod;'>你好！已成功为您连线人工，请选择您的客服专员：:</p>";
                ...
                $.each(res.data,function(k,v){
                    ...
                    str+=' <li class="question" style="list-style:none;  display: inline;" onclick="tz('+business_id +','+v[2] +',' +v[0]+')">【'+v[1]+'】</li>';   
...
function tz(business_id,groupid,id){
    ...
    console.log(business_id)
     ...
     //  window.location.href ='/layer?theme=2eab0f&visiter_id=&visiter_name=&avatar=&&business_id='+business_id+'&groupid='+groupid+'&special='+id

       window.location.href = ROOT_URL+ '/layer?theme=2eab0f&visiter_id=&visiter_name=&avatar=&business_id='+business_id+'&product=%7B%7D&groupid='+groupid+'&special='+id
